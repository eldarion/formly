...
urlpatterns = [
    ...
    url(r"^design/surveys/(?P<pk>\d+)/pages/create/$", design.page_create, name="_page_create"),
    url(r"^design/pages/(?P<pk>\d+)/$", design.page_detail, name="page_detail"),
    url(r"^design/pages/(?P<pk>\d+)/fields/create/$", design.fields_create, name="field_create"),
    ...
    url(r"^design/fields/(?P<pk>\d+)/delete/$", design.FieldDeleteView.as_view(), name="field_delete"),
    url(r"^design/choices/(?P<pk>\d+)/delete/$", design.ChoiceDeleteView.as_view(), name="choice_delete"),
    url(r"^design/pages/(?P<pk>\d+)/delete/$", design.PageDeleteView.as_view(), name="page_delete"),
    url(r"^design/surveys/(?P<pk>\d+)/delete/$", design.SurveyDeleteView.as_view(), name="survey_delete"),
